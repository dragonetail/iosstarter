...
class PhotosController: UICollectionViewController {
    ...
    var viewerController: MediaViewerController?
    ...
    @objc func playPause(gesture: UITapGestureRecognizer) {
        ...
        if let focusedCell = UIScreen.main.focusedView as? UICollectionViewCell {
            if let indexPath = collectionView.indexPath(for: focusedCell) {
                self.viewerController = MediaViewerController(initialIndexPath: indexPath, collectionView: collectionView, isSlideshow: true)
...
extension PhotosController {
    ...
    public override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.viewerController = MediaViewerController(initialIndexPath: indexPath, collectionView: collectionView)
        self.viewerController!.dataSource = self
        self.viewerController!.delegate = self
...
extension PhotosController: MediaViewerControllerDataSource {

    func numberOfItemsInViewerController(_: MediaViewerController) -> Int {
        return self.numberOfItems()
    }

    func viewerController(_: MediaViewerController, viewableAt indexPath: IndexPath) -> Viewable {
...
extension PhotosController: MediaViewerControllerDelegate {
    func viewerController(_: MediaViewerController, didChangeFocusTo _: IndexPath) {}

    func viewerControllerDidDismiss(_: MediaViewerController) {
        #if os(tvOS)
    ...
    func viewerController(_: MediaViewerController, didFailDisplayingViewableAt _: IndexPath, error _: NSError) {
